...
export class K8ClusterComponent implements OnInit {
 // @ViewChild(DaterangepickerDirective) pickerDirective: DaterangepickerDirective;
  ...
  public barChartData: ChartDataSets[] = [
    { data: [65, 59, 80, 81, 56, 55, 40, 80, 81, 56, 55, 40], label: 'Namespace 1' ,fill: false},
    { data: [28, 48, 40, 19, 86, 27, 90, 40, 19, 86, 27, 90], label: 'Namespace 2',fill: false },
    { data: [10, 38, 20, 9, 96, 37, 60, 80, 19, 86, 87, 20], label: 'Namespace 3',fill: false },
    { data: [58, 48, 60, 19, 86, 27, 90, 70, 59, 66, 27, 60], label: 'Namespace 4',fill: false },
    { data: [28, 48, 40, 19, 86, 27, 90, 40, 19, 86, 27, 90], label: 'Namespace 5',fill: false },
    { data: [10, 38, 20, 9, 96, 37, 60, 80, 19, 86, 87, 20], label: 'Others',fill: false }
  ];
